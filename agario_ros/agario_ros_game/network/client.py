...
class GameConnection():
    ...
    def connect_to_game(self, attrs):
...
def start(width=900, height=600, user_name='', user_id=0):
    ...
    icon = pygame.image.load('/workspace/src/agario_ros/agario_ros/img/logo.png')
    ...
    gameconn.connect_to_game({'nick': user_name, 'addr': 'localhost:9999', 'user_id': user_id})
    FPS = 30
